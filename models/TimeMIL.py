...
from layers.inceptiontime import InceptionTimeFeatureExtractor
...
def mexican_hat_wavelet(size, scale, shift, device): #size :d*kernelsize  scale:d*1 shift:d*1
    """
...
#     x = torch.randn(3, 400, 4).to("mps")
#     model = TimeMIL(in_features=4,mDim=128).to("mps")
#     ylogits =model(x)
#     print(ylogits.shape)
